import privateLink from "../../payprivately-contracts/artifacts/contracts/privateLink.sol/privateLink.json";
import privateLinkToken from "../../payprivately-contracts/artifacts/contracts/privateLinkToken.sol/privateLinkToken.json";
...
export const CONTRACT_TO_ABI: { [n: string]: any } = {
  ["privateLink"]: [...privateLink.abi],
  ["privateLinkToken"]: [...privateLinkToken.abi]
}